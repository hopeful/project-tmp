package com.wkb.insurance.common;
...
public class RedisService<K,V> {
    ...
    public Long linsert(final String key, final RedisListCommands.Position where, final String pivot, final String value) {
        if (redisTemplate != null) {
            return redisTemplate.execute(new RedisCallback<Long>() {
                public Long doInRedis(RedisConnection connection)
                        throws DataAccessException {
    ...
    public Set<RedisZSetCommands.Tuple> zRevRangeByScoreWithScores(final String key, final  double max, final double min, final int offset, final int count) {
        if (redisTemplate != null) {
            return redisTemplate.execute(new RedisCallback<Set<RedisZSetCommands.Tuple>>() {
